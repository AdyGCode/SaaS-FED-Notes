...
> **Server Defaults:** Keep values smaller. Beware of setting the memory limit too high.
...
> **PHP requirement:** PHP 8.4 or later.

> **Laragon:** Course resources are available from `https://github.com/adygcode/`.
...
May be prefixed with sub-extensions, or clarifiers
...
> **Security:** Always escape output to help prevent XSS.
...
- Use `__DIR__` as an absolute base for access to file
...
```php {none|1,3|1-3|1-5,8|5-8|all}
$stmt = $pdo->prepare(
...
```php {none|1|3,6,9|3-6,9|3,6-9|all}
