...
Additional information in [S02 Terminology - Business Domain](S02-Terminology-Business-Domain.md).
...
There are a number of network and systems related terms that include Client, Server, Network, LAN, PAN, WAN, and many more. See the [S02 Terminology - Network and Internet](S02-Terminology-Network-Internet.md) article for details on terms not shown below.
