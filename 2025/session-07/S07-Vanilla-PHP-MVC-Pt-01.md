...
Follow the instructions in the [S07-Vanilla-PHP-MVC-Pt-00](S07-Vanilla-PHP-MVC-Pt-00.md) to create the required folder structure if you have not done so already.
...
We are ready to start our PHP... [S07-Vanilla-PHP-MVC-Pt-02](S07-Vanilla-PHP-MVC-Pt-02.md)
